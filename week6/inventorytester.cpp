...
int main() {
    ...
    // Step 3: Use printInventory() to display the initial inventory report
    std::cout << "Initial Inventory:\n";
    inventory.printInventory();

    // Step 4: Test the changePrice() method
    ...
    // Step 5: Use printInventory() to display the final inventory report
    std::cout << "\nFinal Inventory:\n";
    inventory.printInventory();
