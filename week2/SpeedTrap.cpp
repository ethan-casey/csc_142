...
int main() {
    ...
    std::cout<<"Enter the current speed limit: ";
    std::cin>>limit;
    std::cout<<"Enter the drivers current speed: ";
    std::cin>>speed;

    if (speed > limit) {
        std::cout<<"You are speeding and recieved a speeding ticket";
    }
    else {
        std::cout<<"You are obeying the laws";
    }
